...
const initialNodes: Node[] = [
  // Source node
  { id: "ankura", type: "sourceNode", position: { x: 100, y: 120 }, data: { label: "Ankura\nHospital", variant: "ankura" } },
  
  // Candidate flow
  { id: "jobs-ankura", type: "stageNode", position: { x: 250, y: 110 }, data: { label: "Jobs in\nAnkura", icon: "briefcase", handlers: ["C"], borderColor: "border-purple-200" } },
...
const initialEdges: Edge[] = [
  ...
  { id: "e-jobs-discovery", source: "jobs-ankura", target: "job-discovery", type: "default", style: { stroke: "#94a3b8", strokeDasharray: "5,5" } },
