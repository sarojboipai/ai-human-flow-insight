...
import { funnelData, trendData } from "@/lib/mockData";
import { TrendingUp, Clock, Users, Target, Filter } from "lucide-react";
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="dashboard-title">Funnel Analytics</h1>
            <p className="text-muted-foreground mt-1">
              Track conversion rates and time-to-hire metrics
            </p>
          </div>
